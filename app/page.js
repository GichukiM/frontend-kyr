...
const TimelinePage = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col min-h-screen">
        <div className="flex flex-col lg:flex-row">
          <Sidebar className="hidden lg:block lg:w-1/4 lg:sticky lg:top-0" />
          <main className="w-full lg:w-1/2 p-4 lg:p-8 space-y-8">
            {/* Container 1: Post Creation */}
            <div className="flex flex-col lg:flex-row items-center space-y-4 lg:space-x-4 lg:space-y-0 mb-8 border border-black p-4 shadow-md">
              ...
              <div className="flex-1">
                <textarea
                  ...
                  onChange={(e) => setInputValue(e.target.value)}
                ></textarea>
                <div className="flex flex-row items-center space-x-2 lg:space-y-0 lg:space-x-2 mt-2">
                <label htmlFor="video-upload" className="cursor-pointer mr-2 yellow border p-2">
                     🎥
                     <input
                      id="video-upload"
                      type="file"
                  ...
                  <label htmlFor="media-upload" className="cursor-pointer yellow p-2 border rounded-md ">
                    📷
                    <input
                      id="media-upload"
                      type="file"
                  ...
                  <button
                    className="px-4 py-2 yellow text-black rounded-md"
                    onClick={handlePublish}
                  >
                    Publish
                  </button>
        ...
        <div className="space-y-4 lg:space-y-8">
          {isMounted && Array.isArray(posts) && posts.length > 0 && posts.map((post, index) => (
            <div
              key={post.id}
              className={`border border-black bg-gray-100 shadow-md ${index === 0 ? 'mt-0' : 'mt-2 md:mt-4'}`}
            >
              <Post
                post={post}
                comments={comments[post.id] || []}
          ...
          <RightSidebar className="hidden lg:block lg:w-1/4 lg:sticky lg:top-0" />
        </div>
      </div>
      <Services />
      <Partners />
